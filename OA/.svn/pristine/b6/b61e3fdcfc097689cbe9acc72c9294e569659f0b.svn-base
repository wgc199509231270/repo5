$(function () {
    ...
    function ccc() {
        ...
        if (k) {
            var p = '<a href="javascript:;" style="padding: 0 8px" class="active J_menuTab" data-id="' + o + '">' + l + ' <i class="iconfont icon-guanbi-copy" style="font-size: 28px;color:#D8D9DA;float: right;margin-left: -10px;width: 20px;margin-top: -5px"></i></a>';
...
/*$("body").delegate('#table tr a', 'click', function g());*/
