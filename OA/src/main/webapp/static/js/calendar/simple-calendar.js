...
var SimpleCalendar = function () {
  ...
  _createClass(SimpleCalendar, [{
    ...
    value: function create() {
      ...
      //actions
        header.innerHTML = header.innerHTML + '<div class="sc-actions">' + '   <img style="width: 20px;height: 20px;" src="/static/img/calendar.jpg">'+'   <a style="text-decoration:none;' +
            'color:#333; " href="/calendar.html" class="">' + '     <span>&nbsp年份</span></a>' + '      </div>';
      ...
      header.innerHTML = header.innerHTML + '<div style="display: none" class="sc-actions"><span class="sc-return-today ">返回今天</span></div>';
      //header.innerHTML = header.innerHTML + '<div class="sc-actions"><span class="sc-time"></span></div>';
        //header.innerHTML = header.innerHTML + '<div class="sc-actions creatdate"><span">创建日程</span></div>';
        header.innerHTML=header.innerHTML+'<i data-reveal-id="Idiv" class="iconfont icon-fabu createdate"style="position: relative;top: 4px;left: -1px;">创建日程</i>';
        ...
        if (data) {
          ...
          if (data2) {
              ...
              daysElement.forEach(function (v, i) {
                  ...
                  if (data2[year + '-' + currentmonth + '-' + day]) {
                      v.classList.add('sc-mark2');
                      v.title = data2[year + '-' + currentmonth + '-' + day];
                  } else if(data){
                  }else{
    ...
    value: function updateEvent() {
      ...
      key: 'delMark',
      value: function delMark() {
        console.log(this._options.mark)
          this._options.mark={};
          this._options.mark2={};
          this.update();
      }
    ...
    key: 'addMark',
    value: function addMark(day, info, type) {
      if(type=="01"){
          this._options.mark[day] = info;
      }else if(type=="02"){
          this._options.mark2[day] = info;
      }
...
SimpleCalendar.prototype.languageData = {
  ...
  ,data_2019: ['1-1', '2-4', '2-5', '2-7', '2-8', '2-9', '2-10', '2-6', '4-5', '4-6', '4-7', '5-1', '5-2', '5-3','5-4', '6-7', '6-8', '6-9','9-13', '9-14', '9-15', '10-1', '10-2', '10-3', '10-4', '10-5', '10-6', '10-7']*/
  }
};
